...
namespace FTN.Common
{
	...
	public class ModelResourcesDesc
	{
		...
		private void InitializeTypeIdsInInsertOrder()
		{
			...
			typeIdsInInsertOrder.Add(ModelCode.REACTIVECAPCURVE);
		...
		private void InitializeNotSettablePropertyIds()
		{
			...
			notSettablePropertyIds.Add(ModelCode.REGCONTROL_REGCONDEQS);
			notSettablePropertyIds.Add(ModelCode.REACTIVECAPCURVE_SYN_MACHINES);
